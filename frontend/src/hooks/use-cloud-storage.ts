...
export const useCloudStorage = (): CloudStorage => {
  ...
  const setItem = useCallback(
    (key: CloudStorageKeys, value: string | object | object[]) => {
  ...
  const addItem = useCallback(
    async (key: CloudStorageKeys, value: string | object | object[]) => {
      if (
            ...
            try {
              ...
              if (Array.isArray(parsedData)) {
                ...
                if (typeof value === "object" && !Array.isArray(value)) {
                  ...
                  throw new Error(
                    "Cannot merge non-object value with an object",
                  );
                }
              } else {
  ...
  const deleteItem = useCallback((key: string | string[]) => {
